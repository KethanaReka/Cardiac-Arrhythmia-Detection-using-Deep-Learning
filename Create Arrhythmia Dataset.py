...
# Calculate the distribution of arrhythmia categories
arrhythmia_distribution = sample_df['target_str'].value_counts()

# Plot the pie chart
plt.figure(figsize=(8, 8))
plt.pie(arrhythmia_distribution, labels=arrhythmia_distribution.index, autopct='%1.1f%%', startangle=140)
plt.title('Arrhythmia Categories Distribution')
